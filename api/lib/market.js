 ...
 *   TOSS_CLIENT_KEY / TOSS_SECRET_KEY   있을 때만 카드 결제 UI 노출
 */
...
function publicConfig() {
    return {
        ...
        kakaopayLink: process.env.KAKAOPAY_LINK || '',
        bank: {
        ...
        toss: {
            enabled: !!(process.env.TOSS_CLIENT_KEY && process.env.TOSS_SECRET_KEY),
