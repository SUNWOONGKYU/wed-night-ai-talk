# Claude Code 자동 설치 지시문 — 매매 자동화 봇 (Trading Automation Bot) (무료 배포판 v1.1)
...
- 다음 할 일:
  1) 장 시작 전 "오늘 매매 시작" 승인 → 장중(09:00~15:30) 매수(CALL)·매도(PUT) 요청은 "승인/거절"(180초 안에), 청산 요청은 "청산 승인/보류"(120초 안에, 손절은 무응답 시 자동 청산).
