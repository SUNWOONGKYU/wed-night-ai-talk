...
window.MARKET_APPS = [
  { id: 'onemacs', name: 'One MACS · 원맥스', fullname: 'One-stop Multi AI-CLI Console System',
    ...
    dataSafety: {
      ...
      onDevice: ['PIN(암호화)', '오류 기록(모바일 기기 안에만 — 문제 신고 때 본인이 보냄)'],
    ...
    changelog: [   // 사용자 관점 문장 · 버전별 3줄 이내 (근거: 평가_APK완성도_R1~R5.md). 1.4.6 이하는 근거 문서가 없어 비워 둔다(추정 금지)
      { ver: '1.4.9', date: '2026-09-21', notes: ['인터넷이 다시 연결되면 자동으로 다시 접속합니다', '모바일 기기의 글꼴 크기 설정을 그대로 따릅니다', '화면 읽기 도구에서 버튼 이름을 읽어 줍니다'] },
